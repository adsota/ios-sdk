...
#import "AdsOTABannerViewDelegate.h"

@interface AdsOTABannerView : UIView
#pragma mark Initialization

/// Initializes a AdsOTABannerView and sets it to the specified size, and specifies its placement
...
/// Initializes a AdsOTABannerView and sets it to the specified size, and specifies its placement at
...
/// Required to set this banner view to a proper size. Never create your own AdsOTAAdSize directly. Use
/// one of the predefined standard ad sizes (such as kAdsOTAAdSizeBanner), or create one using the
/// AdsOTAAdSizeFromCGSize method. If not using mediation, then changing the adSize after an ad has
...
/// Optional delegate object that receives state change notifications from this AdsOTABannerView.
/// Typically this is a UIViewController. Remember to nil this property before deallocating the
/// delegate.
@property(nonatomic, weak) IBOutlet id<AdsOTABannerViewDelegate> delegate;
