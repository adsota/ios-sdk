...
@class AppotaADBannerView;
@class AppotaADRequestError;

/// Delegate for receiving state change messages from a AppotaADView such as ad requests
/// succeeding/failing or when an ad has been clicked.
@protocol AppotaADBannerViewDelegate<NSObject>
