...
#import "AdsOTAInterstitialDelegate.h"
#import "AdsOTAOfferWallDelegate.h"

@class AdsOTARequest;

@interface AdsOTAInterstitial : NSObject

/// Initializes an interstitial with an ad unit created on the AdsOTA website. Create a new ad unit
...
/// This has no effect unless isReady returns YES and/or the delegate's adsotaInterstitialDidReceiveAd:
/// has been received.
///
...
/// the delegate's adsotaInterstitialDidDismissScreen: will be called.
